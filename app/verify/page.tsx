...
import { ShieldCheck, CheckCircle2, Clock, XCircle, Building2, Loader2, FileText } from 'lucide-react'
            ...
            <div className="space-y-4">
              <div className="p-4 rounded-lg bg-emerald-950/40 border border-emerald-800 text-emerald-300 flex items-center gap-3">
                ...
                <div>
                  ...
                  <p className="text-xs text-emerald-400/80">Digitally processed and signed by Branch Management.</p>
                </div>
              </div>
